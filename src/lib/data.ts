...
export const PROJECTS: Project[] = [
	{
		...
		insights: [
			...
			{
				k: 'Efficiency',
				v: 'Absence of search and filters forces users to scroll every listing.'
			},
			{ k: 'Aesthetics', v: 'Minimal styling gave an unprofessional first impression.' },
			{
				k: 'Error tolerance',
				v: 'No validation or confirmation leaves users unsure if they applied.'
			},
...
// ─── Currently / Now ──────────────────────────────────────────────────────────
// Edit these four cards to reflect what you're up to right now.
...
// ─── About ────────────────────────────────────────────────────────────────────
// Replace intro and paragraphs with your own text.
// stats are shown in the sidebar card on the right.
...
// ─── Contact ──────────────────────────────────────────────────────────────────
// Update your real handles and URLs here.

export const CONTACT: Contact = {
	email: 'diam96@gmail.com',
	socials: [
		{
			label: 'LinkedIn',
			handle: '/in/diam-kanbier',
			url: 'https://www.linkedin.com/in/diam-kanbier'
		},
		{ label: 'Email', handle: 'diam96@gmail.com', url: 'mailto:diam96@gmail.com' },
